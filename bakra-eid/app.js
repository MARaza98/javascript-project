...
eid2.innerHTML =`<h1>2<sup>nd</sup>Eid-Ul-Azha will Celebrate after ${SecEid} Days</h1>`;
var eid3 = document.getElementById('eid3');
eid3.innerHTML =`<h1>3<sup>rd</sup>Eid-Ul-Azha will Celebrate after ${thirdEid} Days</h1>`;
...
eid1.innerHTML = `<h1>1<sup>st</sup> Eid-Ul-Azha will Celebrate after ${firstEid} Days, <br> ${firstEidHours} Hours and ${firstEidMinutes} Minutes</h1>`;
eid2.innerHTML = `<h1>2<sup>nd</sup> Eid-Ul-Azha will Celebrate after ${SecEid} Days, <br> ${SecEidHours} Hours and ${SecEidMintues} Minutes</h1>`;
eid3.innerHTML = `<h1>3<sup>rd</sup> Eid-Ul-Azha will Celebrate after ${thirdEid} Days,<br> ${thirdEidHours} Hours and ${thirdEidMintues} Minutes</h1>`;
...
note.innerHTML = `<b>Note:</b><p>Kindly Make sure done the QURBANI before 3rd Eid Sunset and  ${LastDayQurbani} hour<p>`
